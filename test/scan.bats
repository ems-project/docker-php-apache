...
export BATS_PHP_DOCKER_IMAGE_NAME="${PHP_DOCKER_IMAGE_NAME:-docker.io/zebby76/base-php-apache}:rc"
...
@test "[$TEST_FILE] Launch Clair Scan for [ $BATS_PHP_DOCKER_IMAGE_NAME ] Docker Image" {
  ...
  export BATS_CLAIR_SCAN_DOCKER_IMAGE_NAME="${BATS_PHP_DOCKER_IMAGE_NAME:-docker.io/zebby76/php:rc}"

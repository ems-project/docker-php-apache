# Base PHP + Apache Docker image [![Build Status](https://travis-ci.com/ems-project/docker-php-apache.svg?branch=master)](https://travis-ci.com/ems-project/docker-php-apache)

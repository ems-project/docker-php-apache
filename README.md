# Base PHP + Apache Docker image [![Build Status](https://travis-ci.com/ems-project/docker-php-apache.svg?branch=7.4)](https://travis-ci.com/ems-project/docker-php-apache)

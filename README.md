# Base PHP (Including Dev Tools) + Apache Docker image [![Build Status](https://travis-ci.com/ems-project/docker-php-apache.svg?branch=7.4-dev)](https://travis-ci.com/ems-project/docker-php-apache)
